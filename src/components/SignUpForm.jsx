...
const SignUpForm = ({ role, setRole }) => {
    return ( 
        <form action="" className="flex flex-col gap-[1rem]">
            ...
            <button type="submit" className="bg-primary px-[2rem] py-[0.625rem] rounded-[1.15rem] text-white">ساخت حساب</button>
        </form>
     );
}
